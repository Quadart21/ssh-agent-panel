        ...
        "servers": [
            _row_to_dict(
                ...
                [
                    ...
                    "private_key_enc",
                    "ssh_public_key",
                    "panel_key_fingerprint",
                    "panel_key_deployed_at",
                    "pay_until",
                    "monthly_cost",
                    "billing_period",
                    "currency",
    ...
    for item in payload.get("servers", []):
        db.add(
            Server(
                ...
                private_key_enc=item.get("private_key_enc"),
                ssh_public_key=item.get("ssh_public_key"),
                panel_key_fingerprint=item.get("panel_key_fingerprint"),
                panel_key_deployed_at=_parse_datetime(item.get("panel_key_deployed_at")),
                ...
                agent_token_hash=item.get("agent_token_hash"),
                agent_version=item.get("agent_version"),
                agent_last_seen_at=_parse_datetime(item.get("agent_last_seen_at")),
                agent_cpu_percent=item.get("agent_cpu_percent"),
                agent_ram_percent=item.get("agent_ram_percent"),
                agent_disk_percent=item.get("agent_disk_percent"),
                agent_uptime=item.get("agent_uptime"),
    ...
    for item in payload.get("notification_settings", []):
        db.add(
            NotificationSettings(
                ...
                telegram_topic_general=item.get("telegram_topic_general"),
                telegram_topic_login=item.get("telegram_topic_login"),
                telegram_topic_servers=item.get("telegram_topic_servers"),
                telegram_topic_payments=item.get("telegram_topic_payments"),
                telegram_topic_automation=item.get("telegram_topic_automation"),
