...
from app.routers import accounting, agent, automation, audit, auth, crypto_spread, domains, firewall, groups, linux_users, metric_embeds, notifications, panel_users, patterns, pm2, security, servers, ssh_keys, system, terminal
...
app.include_router(crypto_spread.router, prefix=settings.api_v1_prefix)
...
app.include_router(ssh_keys.router, prefix=settings.api_v1_prefix)
