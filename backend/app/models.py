...
class Server(Base, TimestampMixin):
    ...
    metrics_cpu_percent: Mapped[int | None] = mapped_column(Integer, nullable=True)
    metrics_ram_percent: Mapped[int | None] = mapped_column(Integer, nullable=True)
    metrics_disk_percent: Mapped[int | None] = mapped_column(Integer, nullable=True)
    metrics_uptime: Mapped[str | None] = mapped_column(String(64), nullable=True)
    metrics_online: Mapped[bool | None] = mapped_column(Boolean, nullable=True)
    metrics_available: Mapped[bool | None] = mapped_column(Boolean, nullable=True)
